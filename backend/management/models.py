...
class SiteSettings(SingletonModel):
    ...
    favicon_cropping = ImageRatioField('favicon', '32x32', help_text="The small icon next to the browser tab title. Save new uploaded image then reopen this page to view your new uploaded photo.")
