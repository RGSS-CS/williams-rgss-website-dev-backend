...
class Club(models.Model):
    ...
    repetition = models.CharField(
        blank=True, max_length=10, choices=Repetition.choices, 
    ...
    image = models.ImageField(
        default="clubs/default.png", upload_to=get_upload_path_club
    )
    ...
    accepting_applicants = models.CharField(
        blank=True, max_length=16, choices=AcceptingApplications.choices, 
    ...
    application_form_link = models.URLField(
        ...
        help_text="This can be either a google classroom invite link or a application form link"
        " *It will not be visable when selected 'Not Accepting' in the field below."
    )
    announcement = models.CharField(
        null=True, help_text="This is where you announce application news."  # "BEN ISSUE" -Aiden So, 2026
    )
    day_of_meeting = models.CharField(
        max_length=10, choices=WeekDay.choices, blank=True
    )
    ...
    teacher_advisor = models.CharField(
        ...
        help_text="Please insert the name of the teacher. " \
        "Please insert Mr./Mrs./Ms. , followed by the last name"
    )
    tagline = models.CharField(
        blank=True, max_length=30, 
        help_text="The tagline is the title about your club. " \
        "Make it intruiging such as 'A community of curious minds'"
    )
